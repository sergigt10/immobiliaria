    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h2>Modificar certificat</h2>
              <br>
              <form class="forms-sample" method="post" action="<?php echo URLROOT; ?>/certificats/edit/<?php echo $data['id']; ?>" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input name="nom_cat" type="text" class="form-control" id="exampleInputEmail3" placeholder="Nom del certificat" value="<?php echo $data['nom_cat']; ?>">
                  </div>
