<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#general-pages" <?php echo (strpos($_SERVER['REQUEST_URI'] ,"habitatges") !== false) ? 'aria-expanded="true"' : 'aria-expanded="false"'; ?> aria-controls="general-pages">
        <i class="mdi mdi-table-edit  menu-icon"></i>
        <span class="menu-title">Immobles</span>
        <i class="menu-arrow"></i>
      </a>
      <div <?php echo (strpos($_SERVER['REQUEST_URI'] ,"habitatges") !== false) ? 'class="collapse show"' : 'class="collapse"'; ?> id="general-pages">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link <?php echo (strpos($_SERVER['REQUEST_URI'] ,"habitatges/add") !== false) ? 'active' : ''; ?>" href="<?php echo URLROOT; ?>/habitatges/add">Inserir</a></li>
        </ul>
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link <?php echo (strpos($_SERVER['REQUEST_URI'] ,"habitatges/index") !== false OR strpos($_SERVER['REQUEST_URI'] ,"habitatges/edit") !== false) ? 'active' : ''; ?>" href="<?php echo URLROOT; ?>/habitatges/index">Modificar</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
