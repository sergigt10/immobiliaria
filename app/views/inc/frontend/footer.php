...
<script type="text/javascript" src="<?php echo URLROOT; ?>/js/frontend/chart.min.js"></script>
<script type="text/javascript" src="<?php echo URLROOT; ?>/js/frontend/chart-custome.js"></script>
