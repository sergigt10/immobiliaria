		...
		<div class="container-fluid p0">
            ...
            <nav>
                ...
                <div class="menu-toggle">
                    <img class="nav_logo_img img-fluid" src="<?php echo URLROOT; ?>/images/frontend/header-logo2.png" alt="immobiliàries en xarxa">
                ...
                <a href="<?php echo URLROOT; ?>/immobles/index" class="navbar_brand float-left dn-smd">
                    <img class="logo1 img-fluid" src="<?php echo URLROOT; ?>/images/frontend/header-logo2.png" alt="immobiliàries en xarxa">
                    <img class="logo2 img-fluid" src="<?php echo URLROOT; ?>/images/frontend/header-logo2.png" alt="immobiliàries en xarxa">
                </a>
