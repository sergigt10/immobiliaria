			...
			<div class="row">
				<div class="col-lg-8">
					<div class="home3_home_content">
						...
						<h4>Des de tan sols 40  euros mensuals amb descomptes d’oferta en temps limitat</h4>
					</div>
				</div>
			</div>
			<div class="row">
									...
									<ul class="h1ads_1st_list mb0">
										...
										<li class="list-inline-item">
											<div class="search_option_button">
                                                <button type="submit" class="btn btn-thm3">Cerca</button>
											</div>
										</li>
									</ul>
								</div>
									...
									<ul class="h1ads_1st_list mb0">
										<li class="list-inline-item">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="exampleInputName2" placeholder="Introduïu la paraula clau ...">
                                            </div>
										</li>
										<li class="list-inline-item">
											<div class="search_option_two">
										...
										<li class="list-inline-item">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Ubicació">
										...
										<li class="custome_fields_520 list-inline-item">
											<div class="navbered">
											  	<div class="mega-dropdown home3">
                                                    <span id="show_advbtn2" class="dropbtn">Avançat <i class="flaticon-more pl10 flr-520"></i></span>
                                                    <div class="dropdown-content">
                                                        <div class="row p15">
                                                            <div class="col-lg-12">
                                                                <h4 class="text-thm3">Serveis</h4>
                                                            </div>
                                                                ...
                                                                <ul class="ui_kit_checkbox selectable-list">
                                                                    <li>
                                                                        <div class="custom-control custom-checkbox">
                                                                            ...
                                                                            <label class="custom-control-label" for="customCheck28">Bugaderia</label>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="custom-control custom-checkbox">
                                                                    ...
                                                                    <li>
                                                                        <div class="custom-control custom-checkbox">
                                                                            ...
                                                                            <label class="custom-control-label" for="customCheck30">Cobertes de finestres</label>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </div>
												      	...
												      	<div class="row p15 pt0-xsd">
												      		<div class="col-lg-11 col-xl-10">
												      			<ul class="apeartment_area_list mb0">
												      				...
												      				<li class="list-inline-item">
																		<div class="candidate_revew_select">
																			<select class="selectpicker w100 show-tick">
																				<option>Any de construcció</option>
																				<option>2013</option>
																				<option>2014</option>
																				<option>2015</option>
																				<option>2016</option>
												      		...
												      		<div class="col-lg-1 col-xl-2">
												      			<div class="mega_dropdown_content_closer">
													      			<h5 class="text-thm text-right mt15"><span id="hide_advbtn2" class="curp">Tancar</span></h5>
												      			</div>
												      		</div>
												      	</div>
                                                    </div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="main-title mb40">
						...
						<p>Propietats escollides a mà pel nostre equip<a class="float-right" href="#">Veure tot <span class="flaticon-next"></span></a></p>
					</div>
				</div>
				<div class="col-lg-12">
					<div class="feature_property_home3_slider">
						<div class="item">
							<div class="feat_property home3">
								<div class="thumb">
									<img class="img-whp" src="<?php echo URLROOT; ?>/images/frontend/piso1.jpg" alt="fp1.jpg">
									<div class="thmb_cntnt">
										<ul class="tag mb0">
											<li class="list-inline-item"><a href="#">Venda</a></li>
											<li class="list-inline-item"><a href="#">Destacats</a></li>
										</ul>
										<ul class="icon mb0">
											
											<li class="list-inline-item"><a href="#"><span class="flaticon-heart"></span></a></li>
										</ul>
										<a class="fp_price" href="#">95.000 €<small></small></a>
									</div>
								</div>
								<div class="details">
									<div class="tc_content">
										<p class="text-thm">Pis reformat</p>
										<h4>Pis reformat</h4>
										<p><span class="flaticon-placeholder"></span> Sant Pere 27, Vic, 08500</p>
										<ul class="prop_details mb0">
											<li class="list-inline-item"><a href="#">Habitacions: 4</a></li>
											<li class="list-inline-item"><a href="#">Banys: 2</a></li>
											<li class="list-inline-item"><a href="#">Ref: 5280</a></li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="item">
							<div class="feat_property home3">
								<div class="thumb">
									<img class="img-whp" src="<?php echo URLROOT; ?>/images/frontend/piso2.jpg" alt="fp2.jpg">
									<div class="thmb_cntnt">
										<ul class="tag mb0">
											<li class="list-inline-item"><a href="#">Venda</a></li>
										...
										<a class="fp_price" href="#">195.000 €<small></small></a>
									</div>
								</div>
								<div class="details">
									<div class="tc_content">
										<p class="text-thm">Pis nou</p>
										<h4>Promoció pisos nous</h4>
										<p><span class="flaticon-placeholder"></span> C/ Manlleu 12, Vic, 08500</p>
										<ul class="prop_details mb0">
											<li class="list-inline-item"><a href="#">Habitacions: 3</a></li>
											<li class="list-inline-item"><a href="#">Banys: 2</a></li>
											<li class="list-inline-item"><a href="#">Ref: 3002</a></li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="item">
							<div class="feat_property home3">
								<div class="thumb">
									<img class="img-whp" src="<?php echo URLROOT; ?>/images/frontend/piso3.jpg" alt="fp3.jpg">
									<div class="thmb_cntnt">
										<ul class="tag mb0">
											<li class="list-inline-item"><a href="#">En venda</a></li>
											<li class="list-inline-item dn"></li>
										</ul>
										<ul class="icon mb0">
								...
								<div class="details">
									<div class="tc_content">
										<p class="text-thm">195.000 €</p>
										<h4>Local comercial</h4>
										<p><span class="flaticon-placeholder"></span> Carrer portal de la rambla, Vic 08500</p>
										<ul class="prop_details mb0">
											<li class="list-inline-item"><a href="#">247 m2</a></li>
											<li class="list-inline-item"><a href="#">Banys: 1</a></li>
											<li class="list-inline-item"><a href="#">Sq Ft: 1789</a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="feat_property home3">
								<div class="thumb">
									...
									<div class="thmb_cntnt">
										...
										<a class="fp_price" href="#">1.190000 €</a>
									</div>
								</div>
								<div class="details">
									<div class="tc_content">
										<p class="text-thm">Casa / Chalet</p>
										<h4>Casa familiar de luxe</h4>
										<p><span class="flaticon-placeholder"></span> 1421 San Pedro St, Los Angeles, CA 90015</p>
										<ul class="prop_details mb0">
											<li class="list-inline-item"><a href="#">Habitacions: 6</a></li>
											<li class="list-inline-item"><a href="#">Banys: 6</a></li>
											<li class="list-inline-item"><a href="#">Ref: 30702</a></li>
										</ul>
									</div>
								</div>
							</div>
