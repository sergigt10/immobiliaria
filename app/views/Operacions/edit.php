    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h2>Modificar tipus d'operació</h2>
              <p> * Camps obligatoris </p>
              <br>
              <form class="forms-sample" method="post" action="<?php echo URLROOT; ?>/operacions/edit/<?php echo $data['id']; ?>" enctype="multipart/form-data">
